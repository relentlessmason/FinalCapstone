...
DROP TABLE IF EXISTS  meal_account, users, meal, category_type, time_of_day, meal_plan;
DROP SEQUENCE IF EXISTS seq_user_id, seq_meal_id, seq_meal_account_id,seq_meal_plan_id;
